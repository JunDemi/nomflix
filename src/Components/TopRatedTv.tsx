...
import { getAiring, getMovies, getTopTv, IGetMovieResult, IGetTvResult } from "../api";
...
function TopRatedTv() {
  ...
  const bigMovieMatch = useRouteMatch<{ movieId: string }>("/tv/toptatetv/:movieId");
  ...
  const onBoxClicked = (movieId: number) => {
    history.push(`/tv/toptatetv/${movieId}`);
  };
          ...
          <AnimatePresence>
            {bigMovieMatch ? (
              <>
                ...
                />
                <BigMovie
                  layoutId={bigMovieMatch.params.movieId + "toptatetv"}
